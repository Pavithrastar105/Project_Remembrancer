...
public class TransportMediator extends TransportController {
    ...
    class C00141 implements TransportMediatorCallback {
        C00141() {
        }
    ...
    class C00152 implements Callback {
        C00152() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C00141();
        this.mKeyEventCallback = new C00152();
