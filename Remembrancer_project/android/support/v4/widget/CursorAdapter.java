...
import com.kadomcevi.reminder.DB;
...
public abstract class CursorAdapter extends BaseAdapter implements CursorFilterClient, Filterable {
    ...
    void init(Context context, Cursor c, int flags) {
        ...
        this.mRowIDColumn = cursorPresent ? c.getColumnIndexOrThrow(DB.COLUMN_ID) : -1;
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            this.mRowIDColumn = newCursor.getColumnIndexOrThrow(DB.COLUMN_ID);
