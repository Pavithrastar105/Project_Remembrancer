...
class AccessibilityManagerCompatIcs {
    ...
    static class C00411 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00411(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
