...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00112 extends WorkerRunnable<Params, Result> {
        C00112() {
            super();
        }
    ...
    class C00123 extends FutureTask<Result> {
        C00123(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00112();
        this.mFuture = new C00123(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00134.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
