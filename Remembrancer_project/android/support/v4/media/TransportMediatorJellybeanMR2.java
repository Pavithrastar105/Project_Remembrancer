...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00161 implements OnWindowAttachListener {
        C00161() {
        }
    ...
    class C00172 implements OnWindowFocusChangeListener {
        C00172() {
        }
    ...
    class C00183 extends BroadcastReceiver {
        C00183() {
        }
    ...
    class C00194 implements OnAudioFocusChangeListener {
        C00194() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00161();
        this.mWindowFocusListener = new C00172();
        this.mMediaButtonReceiver = new C00183();
        this.mAudioFocusChangeListener = new C00194();
        this.mPlayState = 0;
