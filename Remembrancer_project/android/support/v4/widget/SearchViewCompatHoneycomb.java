...
class SearchViewCompatHoneycomb {
    ...
    static class C00551 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00551(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00562 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00562(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
